...
This folder contains original design assets and sketches from early development.
...
- `page layout doodle.png` - Original UI/layout planning sketch

**Status:** Reference only. Useful for understanding design evolution.
